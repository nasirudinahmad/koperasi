...
// die;
 ...
 $email = $row['email'];
    $mail = new PHPMailer;
        $subjek = "Tambahan Simpanan";
        $pesan = "Simpanan Rp. $tagihan_simpanan sudah disetujui silahkan cek pada aplikasi koperasi";                
        // $dompdf = "tes";
        ...
        {
        header("location: simpanananggota.php?error7");
        }
