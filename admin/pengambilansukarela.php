...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                ...
                <main>
                    <div class="container-fluid">
                        <ol class="breadcrumb mt-2 mb-2">
                            <li class="breadcrumb-item active">Approved Pengambilan Sukarela</li>
                        </ol>
                        <table id="table-user" class="table table-striped table-bordered table-sm" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">SISA SALDO SUKARELA</th>
                            ...
                            <tbody>
                                        <?php
                                            $no = 1;
                                            $conn= open_db();
                                            $sql = $conn->query("select * from pengambilan");
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                                                              
                                                ...
                                                ?>
                                                <a class="btn btn-success btn-sm" id="11" href="prosespersetujuanpengambilanA.php?id=<?=$data['id']?>&id_user=<?=$data['id_user']?>" role="button" ><i class="fa fa-check-circle mr-2"></i>Setujui</a>
                                                <?php }?>
                                                <?php
        ...
        <script>
            ...
            if(path.indexOf('error16') >-1 ) {
            Swal.fire({
            title: 'Pengajuan pengambilan sukarela di Setujui',
            text: '',
            icon: 'success',
            confirmButtonText: 'OK'
            
        }).then(function() {
            window.location = "pengambilansukarela.php";
        });
        }
        });
