...
$mail->Password = "nasirudina2";           //password email smtp
...
$mail->FromName = "Nasir"; //nama pengirim
...
{
echo "Email pemberitahuan telah dikirimkan ke Email Anda, harap melakukan pembayaran";
}